...
Created draft form for Engl 560 responses to help with the metadata for both mapping projects
Data requested: 

* Chapter
* Location of text
* Character count of text anchored in given location 
* Exhibit object related to location (if applicable)
* Historical signficance of object (if applicable) 
