...
What about these projects interest you, and how might we transfer that interest to our 507 project? 

Also and elsewhere: how did you respond to Bourriaud's *Relational Aesthetics*? What did you make of art as a "bundle of relations with the world," or of form as the invention of "possible encounters," or of models as devices of artistic production, or of gallery visitors helping define an exhibition's structure? 
...
Based on your presentations, we should---at a minimum---articulate core teams (of no more than four people) to work toward making the exhibit happen. Of course, a team may collaborate on multiple projects or facets of the exhibit itself. That is, "team" does not imply "one project."  
...
## Adding Content to Our GitHub Rep (Option 1: No Client) 

If you visit our repo in GitHub, then you can commit files directly to a given directory. Just press the "plus" icon to the right of the file path. Here's a still of the interface: 

[Image of GitHub]() 

There, you can also switch and add branches, using the button on the far left, just above the file path. Here's a still: 
...
The problem with this approach is you're not required to clone a repo to your local drive. Having the repo local affords convenient on- and offline reference, and it speeds up your writing and editing processes (e.g., you can push commits in bulk). It's also difficult to add a new subdirectory/folder when using the GitHub interface.  
...
The perks of this "cloning" approach include: lightweight transfer of data/files, ability to edit locally (without being on the web), and accessibility of the repo to distributed base of people. 
...
Once you've switched to your new branch, commit at least one file to it, namely the version of the prospectus you produced in response to the [thought piece prompt](https://github.com/uvicmakerlab/LongNowOfUlysses/blob/master/English507/ThoughtPiece/thoughtPiecePrompt.md).
...
If---during the planning workshop earlier today---you revised the seminar notes by providing your team's answers to the questions above, then please also commit that file to your branch of the repo. That way, we have documentation of each team's response.  

Throughout the semester, I encourage you to contribute materials to the repo (e.g., notes from the seminar, content you are iteratively producing, and screen grabs of work in progress). Doing so will make your life much easier at the semester's end, when you submit your portfolio.    

## Next Week + The Needs Assessment and Outcomes Statement 

Here's [the prompt](https://github.com/uvicmakerlab/LongNowOfUlysses/English507/NeedsAssessment/needsAssessmentPrompt.md). Please submit it to the master branch of English507/NeedAssessment before next week's meeting. 
...
During next week's meeting, your team should also report on your work thus far. We'll keep the reports to approximately two minutes each, and they will likely be based on the Needs Assessment and Outcomes Statement. Thanks! 
