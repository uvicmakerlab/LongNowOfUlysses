...
## Reviewing the Exhibit Prospectus and Starting Your Thought Piece 

Now, to . . . ahem . . . "push" what we can manage with Git and GitHub in this course, we're going to try versioning the current [Prospectus for the Long Now Exhibit]().  

First, tho, we should read through it and discuss it as a group.  

What seems feasible? What's clear, and what isn't? What appeals to you, and what possibilities or inquiries are missing? 
