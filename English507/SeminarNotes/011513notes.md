...
Now, to . . . ahem . . . "push" what we can manage with Git and GitHub in this course, we're going to try versioning the current [Prospectus for the Long Now Exhibit](https://github.com/uvicmakerlab/LongNowOfUlysses/blob/master/English507/ThoughtPiece/prospectus.md).  
