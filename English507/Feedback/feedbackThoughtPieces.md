...
* LD refines her proposed use of timeline.js to determine how she will prompt people to contribute (I can also help with the data form and model, which will likely be expressed as a spreadsheet); and 
* AlH acquires a model for the cube and determines a way to translate TXT into binary (or her preferred format).  

All that said, the nice bit is that, MJ aside, each of you has a since of what technologies you are using and why. Correct? If not, then please let me know. I'm happy to help direct you, this week and early next included. And MJ: I encourage you to articulate your concept and technique first. Then we'll look for what platform or app is most relevant. Sound good? Also, for you print+ project, you might highlight ways of reading after the screen. In other words, it could be a project about material design, interaction, and attention as much as literary content. (In fact, that perspective might resolve some of your concerns about the content of *Ulysses*.) 
...
Also, DC: as per your request, here's a great [Git cheat sheet](http://rogerdudler.github.com/git-guide/files/git_cheat_sheet.pdf). 

As you continue your work, please keep a log of what you're doing: the decisions you're making, what worked, what didn't, what's interesting at the moment. And then you can commit the logs to our GitHub directory (at "English507/Logs"). These logs will be handy for other people to reference; they will also be great resources at the semester's end. So document as much as you can (in a text editor or the like).    

## Outreach Team: NB, TD, JJ

I'm glad to see there's a group interested in outreach and extending the exhibit beyond its physical location on campus. After listening to your presentations and reading your thought pieces, ND, BTD, and JJ, my first recommendation is to refine the scope of your inquiry (when composing the needs assessment due before our next seminar meeting). Doing so will make your lives much easier for the balance of the semester.  

NB and JJ: it sounds like you are collaborating. Correct? For now, I'll refer to you under that assumption.  

Before Tuesday's meeting, I specifically recommend that: 

* NB and JJ dig into the particulars of their proposed game and determine what's feasible. I heard a lot of ideas floating in the presentation, and I think the key here is getting people where they live. In other words, apply gameful design (a term with which NB is familiar) to people's existing activities, with very little additional effort required on their part. Otherwise, you'll be asking people to commit to yet another space or app, and you might find them reluctant to do so. NB: you specifically recommended experimenting with Google's API. I think this is a great idea, but let me know if you and JJ need help with the particulars. I also like the idea of exploring time and everyday life (perhaps through geocaching) in this project. Whatever the ultimate decision, you'll also want to build usability testing into your timeline. (Again, see me for suggestions.) 

* TD determine how to focus learning and education in this context. Learning about *Ulysses*? Learning digital methods? Learning about *Ulysses* through digital methods? As I mentioned during seminar, the advantage of this learning-oriented project is you can build on the documentation that's emerging in our repo and translate it into something more public-facing, with a pedagogical inflection or tenor. In other words: how could we teach other people how to do what we are doing, and using what kinds of approaches? 

In terms of specific technologies: 

* NB and JJ, before Tuesday's seminar, I recommend identifying the specific app or platform you'll use for the game. Or, you might at least survey possibilities and identify the strengths / appeals of each. You might also articulate what your data will be and how it would be structured. (JJ: tomorrow's data modelling workshop will be helpful here.)   

* TD: it could be that your project only needs technology for dissemination purposes. For instance, what you circulate to larger audiences could be in PDF or the like (ideally, a format and mode that are accessible to a variety of audiences). If that's the case, then I recommend developing the materials first. We can then figure out how to store, index, and reference them online. However, this approach may not appeal to you. For instance, you might want to use a particular web-based platform to underscore how learning is changing and through what mechanisms. If that's the case, then let's talk. And generally speaking: I'd like to hear more about your interests in this particular project, which sounds great! I'm excited to learn more about it.  

As for relevant reading: 

* NB: you might point JJ to your emerging bib on gaming and gamification. Plenty of resources there. 

* TD: you might be interested in [DMLcentral](http://dmlcentral.net/), [IJLM](http://ijlm.net/journal), and [JITP](http://jitp.commons.gc.cuny.edu/). But let me know if I'm off-target here.  

As you continue this work, all of you should keep logs of what you're doing: what's working, what is not working, what you tested, what you tried, and what surprised you. You can then commit these logs periodically to the English507/Logs folder of our GitHub repo.  
